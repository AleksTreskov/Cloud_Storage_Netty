...
import java.util.List;
    ...
    public class Client {
                ...
                while (NetworkClient.getInstance().isConnected()) {
                    ...
                    if (msg != null) {
                        ...
                        if (msg instanceof AbstractMsg) {
                            ...
                            if (incomingMsg instanceof FileSendingMsg) {
                                saveFileToLocalStorage((FileSendingMsg) incomingMsg);
                            }
                        }
                    }
                }
        ...
        private void saveFileToLocalStorage(FileSendingMsg fileMsg) {
        ...
        * */
        ...
        private void uploadFile(Path filePath) throws IOException {
            ...
            NetworkClient.getInstance()
                    .sendObject(new FileSendingMsg(filePath));
        }
        ...
        public void doAuth(String login, String pwd) {
            NetworkClient.getInstance()
                    .sendObject(new AuthorizationMsg(login, pwd));
        }
